  ...
  <Layout>
    <v-row>
      ...
      <v-col cols="12">
        ...
        <p class="subtitle-2">
          Developed by the MARS Glaciology URGE Pod and adapted from the "Sample
          Phd Mentoring Plan" developed by Dr. Vashan Wright (WHOI) and Dr.
          Karin Block (CUNY)
      ...
      <v-col cols="12">
        <p>
          ...
          resources outside of any one University or Institution. In addition to
          providing links to existing resources and programs, we also provide
          descriptions of where you can generally look for resources at your
          home institution as well as providing example resources (e.g.
          mentoring contract, field supply lists).
        </p>
        <Search />
      </v-col>
