<template>
  <Layout>
    <v-container>
      <v-row>
        <v-col cols="12" lg="4">
          <div class="text-lg-h2 text-h3 secondary--text">About</div>
          <v-chip-group column>
            <v-chip
              color="grey lighten-4"
              href="https://twitter.com/cryocommunity"
            >
              <svg
                viewBox="0 0 18 18"
                fill="none"
            ...
            <v-chip color="grey lighten-4" to="/contact">
              <svg
                viewBox="0 0 18 18"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span>CryosphereCommunity@gmail.com</span>
            </v-chip>
          </v-chip-group>
        </v-col>
        <v-col cols="12" lg="6" offset-lg="2">
          <div class="text-h6 font-weight-black text-uppercase">who we are</div>

          <p>
            CryoCommunity is the product of the
            <b>MARS pod's</b> (Midwest And Random Stragglers glaciology)
            participation in
            <g-link href="https://urgeoscience.org/">URGEGeosciences</g-link> in
            Spring 2021. Members of our
            <g-link to="/team">URGE pod</g-link> represent many different
          ...
          <p>
            ...
            cryospheric sciences. We recognize that systematic racism and sexism
            are harmful barriers inherent in academic institutions.
            CryoCommunity aims to share resources and best practices across the
            community and to advocate for the changes needed to create an
            equitable and inclusive culture.
          </p>

          <div class="text-h6 font-weight-black text-uppercase">our vision</div>
          <p>
            Our vision is for cryocommunity.org to as a hub for JEDI resources
            in the cryospheric sciences. While we will continue to share best
            practices and resources developed and currated by the MARS URGE pod,
            we would like to spotlight work by groups within the larger
            glaciological community, and by
            <g-link to="/contact">guest writers</g-link>. This less formal
            format gives us all the flexibility to share helpful information
            free of any pay-walls.
          </p>
        </v-col>
      </v-row>
    </v-container>
