...
export default {
  ...
  data: () => {
    return {
      slackLink: "https://join.slack.com/t/vicesquads/shared_invite/zt-2zq5g0stv-z4wyT7AjTXgonCGezYl27A",
      focus: '',
      type: 'month',
      selectedOpen: false,
      ...
      events: [
        {
          name: 'Professional Development Squad Meeting',
          start: '2025-02-14T10:00:00',
          end: '2025-02-14T11:00:00',
          timed: true,
          moreInformation: "Having hard conversations in academia",
        },
        {
          name: 'Fieldwork Squad Meeting',
          start: '2025-03-17T14:45:00',
          end: '2025-03-17T15:45:00',
          timed: true,
          moreInformation: "Developing field documents: code of conduct, expecations, packing lists",
        },
        {
          name: 'Professional Development Squad Meeting',
          ...
          timed: true,
          moreInformation: "How to study and prepare for graduate school milestones",
        },
        {
          name: 'Professional Development Squad Meeting',
          start: '2025-03-14T10:00:00',
          end: '2025-03-14T11:00:00',
          timed: true,
          moreInformation: "Making figures and graphics",
        },
        {
          name: 'Professional Development Squad Meeting',
          ...
          timed: true,
          moreInformation: "Working with big teams",
        },
        {
          name: 'Professional Development Squad Meeting',
          ...
          timed: true,
          moreInformation: "MHow to mentor and be mentored",
        },
      ],
      value: [new Date()],
      end: '2025-05-31',
