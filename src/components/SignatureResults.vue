<template>
  <div>
    <v-card-text class="mb-1">
      ...
      <span class="ml-2 text-body-1">100</span>
    
    </v-card-text>

    <v-card max-height="300"  elevation="1" class="overflow-y-auto mx-auto">
      <v-list>
...
export default {
  ...
  data: () => ({
    signatures: [
      ...
      {
        name: "Leigh Stearns Ph.D.",
        affiliation: "University of Kansas",
      },
      {
        name: "Lauren Simkins Ph.D.",
        affiliation: "University at Virgina",
      },
      {
        name: "Malisse Lummus",
        affiliation: "University of Kansas",
      ...
      {
        name: "Ravindra Duddu Ph.D.",
        affiliation: "Vanderbilt University",
      },
      {
        name: "Jeremy Bassis Ph.D.",
        affiliation: "University at Michigan",
      },
      {
        name: "Cody Barnett",
        affiliation: "University of Kansas",
      ...
      {
        name: "Celia Trunz Ph.D.",
        affiliation: "Université de Sherbrooke",
      },
      {
        name: "Lizz Ultee Ph.D.",
